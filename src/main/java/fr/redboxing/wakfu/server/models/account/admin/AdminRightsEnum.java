package fr.redboxing.wakfu.server.models.account.admin;
...
public enum AdminRightsEnum {
  ...
  //  REMOVE_FLOOR_ITEMS(37, new short[]{64}),
   ...
   // NEW_REQUEST_SANCTIONS(54, new short[]{112}),
    ...
    UNKNOWN1(84, new short[] { 23, 24, 33, 60, 99, 97, 98, 44, 135, 78, 26, 77, 101, 100 }),
    UNKNOWN2(85, new short[] { 242, 243, 245, 244, 248, 276, 247 }),
    UNKNOWN3(86, new short[] { 246 }),
    UNKNOWN4(87, new short[] { 249, 250, 251, 253, 285, 286 }),
    UNKNOWN5(88, new short[] { 254, 255, 256, 257, 258, 259, 260 }),
    UNKNOWN6(89, new short[] { 273, 275 }),
    UNKNOWN7(90, new short[] { 265, 266 }),
    UNKNOWN8(92, new short[] { 293 }),
    ...
    UNKNOWN9(161, new short[0]),
    UNKNOWN10(162, new short[0]);
